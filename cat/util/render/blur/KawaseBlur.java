package cat.util.render.blur;

import cat.util.RenderUtil;
import cat.util.render.ShaderUtil;
...
public class KawaseBlur {
    public static ShaderUtil kawaseDown = new ShaderUtil("cat/shaders/kawaseDown.frag");
    public static ShaderUtil kawaseUp = new ShaderUtil("cat/shaders/kawaseUp.frag");
