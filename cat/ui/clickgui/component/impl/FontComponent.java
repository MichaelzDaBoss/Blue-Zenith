...
import cat.module.value.types.FontValue;
...
public class FontComponent extends Component implements Visible {

    public FontValue mode;

    public FontComponent(FontValue mode) {
        this.mode = mode;
    }
    ...
    public void drawPre(double x, double y, int mouseX, int mouseY) {
        ...
        FontUtil.fontOpenSansRegular36.drawString(mode.get().getName(), (float) (x + width - FontUtil.fontOpenSansRegular36.getStringWidth(mode.get().getName()) - 2),
