...
import cat.module.modules.movement.KeepSprint;
                ...
                if (f > 0.0F || f1 > 0.0F)
                {
                    ...
                    if (flag2)
                    {
                        if (i > 0)
                        {
                            ...
                            if(!(ModuleManager.getModuleClass(KeepSprint.class).getState() ||
                                    (((Aura)ModuleManager.getModuleClass(Aura.class)).keepSprint.get() && ModuleManager.getModuleClass(Aura.class).getState()))) {
                                this.motionX *= 0.6D;
                                this.motionZ *= 0.6D;
