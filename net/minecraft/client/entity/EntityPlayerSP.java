...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdateWalkingPlayer() {
        ...
        if (this.isCurrentViewEntity()) {
            ...
            boolean flag2 = d0 * d0 + d1 * d1 + d2 * d2 > 0 || this.positionUpdateTicks >= 20;
            ...
            UpdatePlayerEvent event2 = new UpdatePlayerEvent(event.yaw, event.pitch, event.x, event.y, event.z, event.onGround, EventType.POST);
    ...
    public void onLivingUpdate() {
        ...
        if (((this.isUsingItem() || Aura.isActuallyBlocking()) && !this.isRiding())) {
